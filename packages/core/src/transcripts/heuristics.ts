...
const INLINE_TAG_PATTERN =
  /<(user_message|assistant_response|timestamp|info_added_to_conversation_history|environment_details|system|potentially_relevant_details|feedback_history|auto_mode_status|tool_response|tool_name|tool_status|parameter|execute_command|read_file|write_to_file|search_files|browser_action|mcp_server|thinking)[^>]*>[\s\S]*?<\/\1>/gi;

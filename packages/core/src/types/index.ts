...
export type ReviewStatus = 'needs_review' | 'accepted' | 'rejected' | 'blocked' | 'superseded';

export type ConflictPolicy = 'shadow' | 'reject' | 'soft-merge' | 'needs_review_if_state_differs';
...
export type ArtifactFormat = 
  | 'markdown' | 'typescript' | 'javascript' | 'json' | 'yaml'
  | 'python' | 'sql' | 'cypher' | 'mermaid' | 'unknown';

export type ArtifactRole = 
  | 'intent' | 'spec' | 'code' | 'test' | 'doc' | 'config';

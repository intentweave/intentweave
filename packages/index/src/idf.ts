...
const STOPWORD_BASELINE = new Set([
  ...
  "system", "implementation", "approach", "solution", "overview",
  "configuration", "application", "component", "module", "service",
  "function", "method", "class", "interface", "type",
  "data", "value", "result", "response", "request",
  "process", "operation", "action", "event", "handler",
  "state", "status", "context", "scope", "instance",
  // Documentation filler
  "example", "documentation", "description", "information", "details",
  "section", "chapter", "guide", "reference", "note",
  // Architecture filler
  "layer", "level", "step", "stage", "phase",
  "input", "output", "parameter", "argument", "option",
  "error", "issue", "problem", "update", "change",
  "file", "directory", "path", "name", "list",
]);

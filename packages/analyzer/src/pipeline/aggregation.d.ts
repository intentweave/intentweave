...
import type { Entity, Statement, LinkProposal, LxStageOutput } from '@intentweave/core';
 ...
 */
export declare function runAggregation(input: AggregationInput, ctx: PipelineContext, options?: AggregationOptions): Promise<AggregateOutput>;
/**
 ...
 */
export declare function formatLxProposals(proposals: LxProposal[], processedAt: string): LxProposalsFile;
/**
 ...
 */
export declare function persistAggregateOutput(output: AggregateOutput, runId: string, runStore: {
    saveAggregates(runId: string, aggregates: Record<string, unknown>): Promise<void>;
}, logger?: {

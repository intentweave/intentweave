 ...
 */
import type { LLMProvider, ExtractionProvider, ExtractionConfig } from '@intentweave/core';
 ...
 */
export declare function createPipelineContext(options: PipelineContextOptions): PipelineContext;
/**
 ...
 */
export declare function completeRunMeta(meta: PipelineRunMeta, summary: PipelineRunMeta['summary'], completedAt: string): PipelineRunMeta;
/**
 * Mark run as failed
 */
export declare function failRunMeta(meta: PipelineRunMeta, error: string, failedAt: string): PipelineRunMeta;
/**

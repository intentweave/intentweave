 ...
 */
export declare function runMxStage(input: MxStageInput, ctx: PipelineContext, options?: MxStageOptions): Promise<MxStageOutput>;
/**
 ...
 */
export declare function getTransitionEntities(mxOutput: MxStageOutput): Entity[];
/**

 ...
 */
import type { ExtractionProvider, Chunk, EntitySchema, ExtractionProfile, Entity, Statement, Evidence, ExtractionHooks } from '@intentweave/core';
/**
 * RX Stage Options
 */
 ...
 */
export declare function runRxStage(input: RxStageInput, options: RxStageOptions, hooks?: ExtractionHooks): Promise<RxStageOutput>;
/**
 * Create chunks from text content
 */
export declare function createChunksFromContent(content: string, filePath: string, options?: {
    maxChunkSize?: number;
    artifactId?: string;
}): Chunk[];

...
- **Cache schema** (`.iw/adaptive-cache.json`, repo-scoped to workspace root):
  ```json
  {
    ...
    "pathBoosts": {
      "packages/auth/": {"boost": 1.15, "hits": 8, "lastSeen": "2026-06-21T10:25:00Z"},
      "docs/decisions/": {"boost": 1.05, "hits": 3, "lastSeen": "2026-06-21T10:20:00Z"}
    },
    "entityBoosts": {
      "AuthService": {"boost": 1.2, "hits": 12, "lastSeen": "2026-06-21T10:18:00Z"}
    },
    "queryPatterns": {
...
- Acceptance criteria:
  ...
  - noisy-path share ≤15% (baseline acceptance)
- Code touch points:
